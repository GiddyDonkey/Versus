...
self.addEventListener('notificationclick', function(event) {
    ...
    // Hardcoded base URL for GitHub Pages
    var baseUrl = 'https://giddydonkey.github.io/Versus/';
    
    var targetUrl = baseUrl;
    var challengeId = event.notification.data ? event.notification.data.challengeId : null;
    
    // Add challenge deep link hash if present
    if (challengeId) {
        targetUrl = baseUrl + '#challenge=' + challengeId;
    }
